...
I’m motivated by curiosity, structure, and the desire to understand how things work.
...
- New interactive features (projects section, visual timelines, etc.)
...
Users interact with a web app → upload a photo → choose interests → a robot arm draws a stylized portrait live on paper

**My focus:**
- Designed and developed the **user interface** and **project pipeline**
- Worked on **AI-based image generation** and **prompt creation**
- Led **planning and task organization** within the team
- Gained perspective on **image preprocessing** and **robotics** from my colleagues
...
- Robotics for real-world application  
- Human languages (self-studying out of curiosity)
...
**Interests to grow into:**  
Machine learning · Robotics · Hardware prototyping · Medical data processing · PCB Design · 
